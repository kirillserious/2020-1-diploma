...
Ниже приведем таблицу с описанием констант в системе \eqref{eq:example} и их характерными значениями для электродвигателя:
...
\begin{figure}[bh]
        \noindent\centering{
        \includegraphics[width=160mm]{content/example/simple-control.eps}
        }
...
\begin{figure}[bh]
        \noindent\centering{
        \includegraphics[width=160mm]{content/example/simple-tr.eps}
        }
...
\begin{figure}[bh]
        \noindent\centering{
        \includegraphics[width=160mm]{content/example/small-control.eps}
        }
...
\begin{figure}[bh]
        \noindent\centering{
        \includegraphics[width=160mm]{content/example/small-tr.eps}
        }
...
\begin{figure}[bh]
        \noindent\centering{
        \includegraphics[width=160mm]{content/example/cpu.eps}
        }
